...
{
	/**
     * Get detailed hashtag information via web request.
     *
     ...
     */
	 	 public function  getInfoGraph($hashtag)
    {
       $csrftoken  = $this->ig->client->getToken();
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL            => "https://www.instagram.com/explore/tags/{$hashtag}/?__a=1",
            ...
            CURLOPT_HTTPHEADER     => [
                ...
                "Cookie: mid=".$mid."; ds_user_id=$ds_user_id; X-IG-Capabilities:  user-agent=$useragent; 36oH; X-IG-Connection-Speed:	1432kbps; Accept: */*; Accept-Language: en-AE;q=1; Host: i.instagram.com; Accept-Encoding: gzip, deflate; Proxy-Connection: keep-alive; Connection: keep-alive; X-IG-App-ID=936619743392459; X-Instagram-AJAX=f87b0d040435; X-Requested-With=application/x-www-form-urlencoded; charset=UTF-8;  csrftoken=$csrftoken; sessionid=$sessionid; rur=$rur; urlgen=$urlgen"
            ],
        ]);
